...
public class CandidateWorkHistory {
    ...
    public CandidateWorkHistory() {
        ...
        this.startDate = rand.randString(1,12) + "/" + rand.randString(1,28) + "/" + rand.randString(2000,2007);
        this.endDate = rand.randString(1,12) + "/" + rand.randString(1,28) + "/" + rand.randString(2008,2015);
