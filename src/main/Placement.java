...
public class Placement {
    ...
    private String header = "jobOrder.title,candidate.id,dateBegin,payRate,employmentType";
    ...
    public Placement() {
        ...
        this.candidateID = constants.camdidateIDs[rand.randInt(0,constants.camdidateIDs.length-1)];
